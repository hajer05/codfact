...
public class OllamaService {
    ...
    public String getConsultingResponse(String userMessage) {
        try {
            return callOllama(CONSULTING_SYSTEM_PROMPT, userMessage);
        } catch (Exception e) {
            log.error("Erreur Ollama pour consulting: {}", e.getMessage(), e);
    ...
    public String getCoursesResponse(String userMessage) {
        try {
            return callOllama(COURSES_SYSTEM_PROMPT, userMessage);
        } catch (Exception e) {
            log.error("Erreur Ollama pour courses: {}", e.getMessage(), e);
    ...
    public String getUniversalResponse(String userMessage) {
        try {
            ...
            return callOllama(fullSystemPrompt, userMessage);
        } catch (Exception e) {
            log.error("Erreur Ollama universelle: {}", e.getMessage(), e);
            return "Désolé, je rencontre un problème technique. Veuillez réessayer plus tard ou contacter le support.";
        }
    }
    ...
    private String callOllama(String systemPrompt, String userMessage) {
        try {
            ...
            throw new RuntimeException("Erreur de communication avec Ollama", e);
        }
    }
