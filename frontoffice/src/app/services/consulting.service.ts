...
export class ConsultingService {
  ...
  createRequest(request: CreateConsultingRequest): Observable<ConsultingRequest> {
    return this.http.post<ConsultingRequest>(`${this.apiUrl}/request`, request)
      .pipe(catchError(this.handleError));
  }

  getMyRequests(): Observable<ConsultingRequest[]> {
    return this.http.get<ConsultingRequest[]>(`${this.apiUrl}/requests`)
      .pipe(catchError(this.handleError));
  }
  ...
  // Admin methods
  getAllRequestsAdmin(): Observable<ConsultingRequest[]> {
